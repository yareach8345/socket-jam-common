...
fun HueAllocator(roomDto: RoomDto): HueAllocator {
    val usedHueValues = roomDto.users.map { it.colorHue }.toSet()
    return HueAllocator(usedHueValues, roomDto.maxUserCount)
}